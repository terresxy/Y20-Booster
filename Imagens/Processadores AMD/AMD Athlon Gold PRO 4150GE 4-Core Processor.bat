...
reg add "HKEY_LOCAL_MACHINE\HARDWARE\DESCRIPTION\System\CentralProcessor\0" /v "ProcessorNameString" /t REG_SZ /d "AMD Athlon Gold PRO 4150GE 4-Core Processor           " /f >nul 2>&1
